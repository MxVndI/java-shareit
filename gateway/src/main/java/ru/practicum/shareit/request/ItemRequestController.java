...
public class ItemRequestController {
    ...
    @GetMapping
    public ResponseEntity<Object> getItemRequestsOfRequestor(@RequestHeader("X-Sharer-User-Id") Integer userId) {
    ...
    @GetMapping("/all")
    public ResponseEntity<Object> getItemRequestsOfAllUsers(@RequestHeader("X-Sharer-User-Id") Integer userId) {
    ...
    public ResponseEntity<Object> getItemRequestById(@Valid @PathVariable Integer requestId,
                                                     @RequestHeader("X-Sharer-User-Id") Integer userId) {
